...
|---|---|
| [SPEC.md](SPEC.md) | The original technical specification the package was built from (in Spanish) — behaviour, data formats, and CLI surface as originally designed. |
