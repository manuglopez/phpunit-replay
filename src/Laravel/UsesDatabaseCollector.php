 ...
 * Filled by `PHPUnit\Subscribers\ArmLaravelTrackersOnPrepared`, flushed to
 * `<runDir>/uses_database.json` by `PHPUnit\Subscribers\FlushUsesDatabaseOnExecutionFinished`.
 */
